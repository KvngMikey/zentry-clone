...
const Story = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    const x = clientX - rect.left; //doing these to calculate the center of the image.
    const y = clientY - rect.top;

    const centerX = rect.width / 2;
    const centerY = rect.height / 2;

    //calculate the rotation based on mouse position relative to the center of the image
